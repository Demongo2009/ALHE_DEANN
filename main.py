...
class DE:
    ...
    def crossover(self, specimen, donorVector):
        ...
        trialVector = [
            donorVector[i] if random.uniform(0, 1) <= self.dEParams.crossoverProbability or i == randomI else specimen[i]
    ...
    def evaluate(self, trialVector, specimen, population):
        ...
        self.dEParams.evaluationFunction(trialVector, trialVector_val, self.dEParams.dimensions, 1, self.dEParams.funNumCEC)
    ...
    def run(self):
        ...
        while fes < params.maxfes:
            ...
            if(debug):
                ...
                print("Sample from population: " + np.random.choice(population,1))
...
if __name__ == '__main__':
    ...
    parser.add_option("-d", "--dimensions", type="int", dest="dimensions", default=5,
                      help="Number of dimension (default 5)")
    parser.add_option("-f", "--function", type="int", dest="function", default=31,
                      help="function number (default 31) [number 31 is quadratic function, number 32 is Rosenbrock]")
